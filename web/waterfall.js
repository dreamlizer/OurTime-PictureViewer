...
function publicShelfCard(p,offset){const shelf=state.publicFigures||{};const count=Number(shelf.count)||0;const countLabel=!shelf.ready&&!count?'正在整理':count+'张';return `<article class="photo-card public-figure-card" data-photo="shelf" data-position="${offset}" tabindex="0" role="button" aria-label="打开公众人物，${countLabel}" style="left:${p.x}px;top:${p.y}px;width:${p.width}px"><div class="photo-frame public-figure-frame" style="height:${p.picture}px"><span class="public-figure-mark" aria-hidden="true"><img src="/assets/public-figures-logo.png" alt=""></span></div><div class="card-caption"><div class="card-meta"><b>公众人物</b><span>${countLabel}</span></div></div></article>`}
