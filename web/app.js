...
function updateChrome(){
  ...
  const stickyBrowserView=view==='people'||['home','home-group','timeline','folders','places','groups','favorites'].includes(view)||String(view).startsWith('place:')||String(view).startsWith('group:')||isPhotoPlaceView(view);
  ...
  $$('.nav[data-view]').forEach(el=>{
    el.classList.toggle('active',el.dataset.view===view||(el.dataset.view==='home'&&(view==='home'||view==='home-group'))||(el.dataset.view==='timeline'&&isTimelineView(view))||(el.dataset.view==='places'&&(String(view).startsWith('place:')||isPhotoPlaceView(view)))||(el.dataset.view==='groups'&&isGroupView(view)));
  });
}
