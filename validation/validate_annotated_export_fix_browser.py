            ...
            try:
                ...
                with sync_playwright() as playwright:
                    ...
                    for aid, theme, vertical, signature_clicks, expected_faces, slug in scenarios:
                        ...
                        check(
                            all(token not in markup for token in ("viewer-photo-close", "photo-favorite", "photo-place-map", "photo-export-control", "signature-switch", "photo-people-hud", "people-manage-popover", "face-action-popover")),
                            f"{slug} 冻结快照排除全部交互控件",
                            checks,
                        )
                        check(
