...
def main():
    with tempfile.TemporaryDirectory() as tmp:
        ...
        try:
            snap = {"snapshot_version":2,"dialog_attrs":{"data-face-theme":"tea"},"dialog_style":'--face-label-s-image: url("/api/face-label-bg/4.png"); --face-font-size: 15px; --face-font-family: "Microsoft YaHei"; --face-bg-opacity: 0.7;',"geometry":{"image_width":1000,"image_height":600,"mat_width":1000,"mat_height":720},"mat_html":'''<figure id="photo-mat" style="position:relative;width:1000px;height:720px"><img id="detail-img"><div id="face-name-layer" class="face-name-layer"><button class="face-name" data-face-label-size="s" style="left:110px;top:150px">王小明</button></div><figcaption id="photo-signature"><div class="signature-v3"><span class="signature-seal">拾</span><div class="signature-capture"><strong>2026 年秋 · 北京</strong><small>SONY · 35mm · f/2</small></div></div></figcaption></figure>'''}
